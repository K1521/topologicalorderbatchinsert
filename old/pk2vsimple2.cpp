...
class topologicalordering{
    ...
    public:        
        ...
        void discover(typename std::vector<Edge<T>>::iterator start,
            ...
            /*bool isSorted = std::is_sorted(start, end, [](const Edge<T>& edge1, const Edge<T>& edge2) {
            ...
            if (isSorted) {
                ...
                std::cout << "The vector segment is not sorted.\n";
            }
...
//for(int j=0;j<10000;++j){
    ...
    int myNumbers[16] = {1,2,4,8,16,128,1024,8192,65536,524288,4194304,33554432};
    for (int j = 0; j < 16; j++) {
        ...
        std::cout << "time: " << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count() << " microseconds" <<" inserts every:"<<insertsintervall<< std::endl;
    }
